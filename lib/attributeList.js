module.exports = {
  ...
  "accept-charset":{
    "name":"accept-charset",
    "belongsTo":"<form>",
    "description":"Specifies that audio/video controls should be displayed (such as a play/pause button etc)"
  },
  "accesskey":{
    "name":"accesskey",
    "belongsTo":"Global Attributes",
  ...
  "cite":{
    "name":"cite",
    "belongsTo":"<blockquote>, <del>, <ins>, <q>",
  ...
  "href":{
    "name":"href",
    "belongsTo":"<a>, <area>, <base>, <link>",
    "description":"Script to be run on abort"
  },
  "hreflang":{
    "name":"hreflang",
    "belongsTo":"<a>, <area>, <link>",
  ...
  "label":{
    "name":"label",
    "belongsTo":"<track>, <option>, <optgroup>",
  ...
  "max":{
    "name":"max",
    "belongsTo":"<input>, <meter>, <progress>",
  ...
  "media":{
    "name":"media",
    "belongsTo":"<a>, <area>, <link>, <source>, <style>",
  ...
  "onabort":{
    "name":"onabort",
    "belongsTo":"<audio>, <embed>, <img>, <object>, <video>",
  ...
  "onblur":{
    "name":"onblur",
    "belongsTo":"All visible elements.",
    "description":"Script to be run when an error occurs"
  },
  "oncanplay":{
    "name":"oncanplay",
    "belongsTo":"<audio>, <embed>, <object>, <video>",
  ...
  "onload":{
    "name":"onload",
    "belongsTo":"<body>, <iframe>, <img>, <input>, <link>, <script>, <style>",
  ...
  "onmousedown":{
    "name":"onmousedown",
    "belongsTo":"All visible elements.",
    "description":"Script to be run when the user writes something in a search field (for <input='search'>)"
  },
  "onmousemove":{
    "name":"onmousemove",
    "belongsTo":"All visible elements.",
  ...
  "onpaste":{
    "name":"onpaste",
    "belongsTo":"All visible elements.",
    "description":"Script to be run when a page has unloaded (or the browser window has been closed)"
  },
  "onpause":{
    "name":"onpause",
    "belongsTo":"<audio>, <video>",
  ...
  "onscroll":{
    "name":"onscroll",
    "belongsTo":"All visible elements.",
    "description":"Specifies if and how the author thinks the audio/video should be loaded when the page loads"
  },
  "onsearch":{
    "name":"onsearch",
    "belongsTo":"<input>",
  ...
  "onunload":{
    "name":"onunload",
    "belongsTo":"<body>",
    "description":"Specifies the width, in characters (for <input>) or specifies the number of visible options (for <select>)"
  },
  "onvolumechange":{
    "name":"onvolumechange",
    "belongsTo":"<audio>, <video>",
  ...
  "required":{
    "name":"required",
    "belongsTo":"<input>, <select>, <textarea>",
    "description":"Specifies the target for where to open the linked document or where to submit the form"
  },
  "reversed":{
    "name":"reversed",
    "belongsTo":"<ol>",
  ...
  "sizes":{
    "name":"sizes",
    "belongsTo":"<img>, <link>, <source>",
    "description":"Specifies the size of the linked resource"
  },
  "span":{
    "name":"span",
    "belongsTo":"<col>, <colgroup>",
    "description":"Specifies the number of columns to span"
  },
  "spellcheck":{
    "name":"spellcheck",
